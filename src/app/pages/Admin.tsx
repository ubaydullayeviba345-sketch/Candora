    ...
    return (
      <main className="min-h-screen bg-background text-foreground flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <form onSubmit={handleLogin} className="relative w-full max-w-md bg-card border border-border rounded-3xl p-7 shadow-2xl">
          <div className="flex items-center gap-3 mb-8"><div className="w-10 h-10 overflow-hidden bg-black"><img src="/candora-logo.jpg" alt="Candora" className="w-full h-full object-contain" /></div><div><p className="font-display text-xl font-bold">Candora Admin</p><p className="text-xs text-muted-foreground">Boshqaruv paneliga kirish</p></div></div>
    ...
    <main className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border bg-card/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3"><div className="w-9 h-9 overflow-hidden bg-black"><img src="/candora-logo.jpg" alt="Candora" className="w-full h-full object-contain" /></div><div><p className="font-display text-xl font-bold">Candora Admin</p><p className="text-xs text-muted-foreground">Boshqaruv markazi</p></div></div>
